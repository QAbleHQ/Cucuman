...
public class ClassMethodsValidator {
    ...
    public static void main(String[] args) {
        ...
        validator.prepare_list_of_element_not_generated("/Users/viralpatel/Viral/object_repository_generator/src/test/java/web/web.object_repository/login_page/registration/search_page.json", "web.web.object_repository.login_page.registration.search_page_steps");
    }
