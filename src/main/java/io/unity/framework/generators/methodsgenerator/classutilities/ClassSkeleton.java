...
public class ClassSkeleton {
    ...
    public String get_package_name(String destination_path, String type) {
        ...
        if (type.equals("mobile")) {
            package_name = "mobile.web.object_repository" + package_path.split("mobile.object_repository")[1];
...
//  /Users/viralpatel/Viral/object_repository_generator/src/test/java/web/web.object_repository/login_page/registration/search_page.java
//  /Users/viralpatel/Viral/object_repository_generator/target/test-classes/web/web.object_repository/login_page/registration
