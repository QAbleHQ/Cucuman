...
public class ClientManagement {
	...
	@MethodsData(method_id = "button_1")
	public void verify_new_element_is_present_on_page() {
		verify.element_is_present("new_element");
	}
	@MethodsData(method_id = "button_2")
	public void verify_new_element_is_clickable() {
		verify.element_is_enable("new_element");
	}
	@MethodsData(method_id = "button_3")
	public void click_on_new_element() {
		element.click("new_element");
	}
	@MethodsData(method_id = "button_4")
	public void Verify_new_element_text_is_equal_to(String button_text) {
		verify.element_text_is_equal_to("new_element", button_text);
	}
}